          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <div className="flex justify-center gap-6">
              <a href="https://www.instagram.com/eviproia" target="_blank" rel="noopener noreferrer"
                className="text-gray-500 hover:text-white transition-colors text-xs font-mono flex items-center gap-1.5">
              ...
              <a href="https://www.facebook.com/profile.php?id=61564739967796" target="_blank" rel="noopener noreferrer"
                className="text-gray-500 hover:text-white transition-colors text-xs font-mono flex items-center gap-1.5">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Links legales */}
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-xs font-mono text-gray-600">
